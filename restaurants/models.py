		...
		if query:
			...
			return self.filter(Q(name__icontains=query)|
							   ...
							   Q(item__contents__icontains=query)
						   	   ).distinct()	# RestaurantLocation.objects.all().search(query) # RestaurantLocation.objects.filter(something).search
		else:
			return self
...
class RestaurantLocation(models.Model):
	...
	objects = RestaurantLocationManager() # Important to add!!
